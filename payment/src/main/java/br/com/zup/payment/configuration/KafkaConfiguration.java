...
public class KafkaConfiguration {
    ...
    @Bean
    public NewTopic rejectPayment() {
        return new NewTopic("reject-payment", 1, (short) 1);
    }

    @Bean
    public NewTopic approvePayment() {
        return new NewTopic("approved-payment", 1, (short) 1);
    }



    @KafkaListener(topics = "approved-inventory", groupId = "payment-group-id")
    public void listen(String message) throws IOException {
        ...
        paymentService.validPayment(event);
    }
}
